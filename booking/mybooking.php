...
?> 
    ...
    ?>
                            <tr>
                                ...
                                <td class="column5"><?php $startTime=$rs['start']; $endTime=$rs['end']; echo thai_time(strtotime($startTime)).'-'.thai_time(strtotime($endTime)); ?></td>
                                <td class="column6">
                                    <?php 
            ...
            <h3 class = "edit">แก้ไข</h3>
                ...
                <div class="container-1-box"> 
                    ...
                    <select name="people" id="room" required>
                        <!-- <option value="<?php echo $meResult2['people'];?> <?php if ($meResult['people'] == $meResult2['people']) {echo 'selected';}?>"><?php echo $meResult2['people'];?></option> -->
                ...
                <div class="container-1-box"> 
                    ...
                    <select class="starttime" id="starttime" name='starttime'required> 
                        <option value="8:01" <?php if ($starttime = date('H:i',strtotime($meResult2['start'])) == '08:01') {echo 'selected';}?>>8:00 น.</option>
                        <option value="8:31" <?php if ($starttime = date('H:i',strtotime($meResult2['start'])) == '08:31') {echo 'selected';}?>>8:30 น.</option>
                        <option value="9:01" <?php if ($starttime = date('H:i',strtotime($meResult2['start'])) == '09:01') {echo 'selected';}?>>9:00 น.</option>
                        <option value="9:31" <?php if ($starttime = date('H:i',strtotime($meResult2['start'])) == '09:31') {echo 'selected';}?>>9:30 น.</option>
